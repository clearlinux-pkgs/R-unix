...
Version  : 1.3
Release  : 1
URL      : https://cran.r-project.org/src/contrib/unix_1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/unix_1.3.tar.gz
Summary  : Unix System Utilities
...
export LANG=C
export SOURCE_DATE_EPOCH=1547737486
